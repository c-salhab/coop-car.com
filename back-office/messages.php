<!DOCTYPE html>
<html>
      <?php $title = 'Messages Des Utilisateurs'; include('../include/head.php'); 
...
<body>
      ...
      <ul>
        ...
        <li><a  class="active" href="messages.php">Messages Utilisateurs</a></li>
        <li><a  href="../../log.txt">Logs</a></li>
        <li><a href="mention.php">Mention Legale</a></li>
      ...
      <br>
      <h2><i>Bonjour, bienvenue sur l'espace Administrateur de coop-car.</i></h2>
      <h3><i>Vous pouvez voir touts les messages envoyes</i></h3><br>
      
      <div class="eight">
      <h1>Les messages des utilisateurs: </h1>
      </div><br>
      ...
      <table id="customers">
        ...
        <tbody id="user-table">
          <?php
                ...
                $q = 'SELECT id,nom,email,message FROM contact';
                $req = $bdd->query($q);
                $res = $req->fetchAll();
                foreach ($res as $i) 
                {
                  ...
                  echo '<td>' . $i['nom'] . '</td>';
                  echo '<td>' . $i['email'] . '</td>';
                  echo '<td><b>' . $i['message'] . '</b></td>';
                  echo '<td>';
                  echo '<a href="mailto:' . $i['email'] . ' ">Envoyer Un Mail</a><br>';
                  echo '<a href=suppr_message.php?id='.$i['id'].'>Supprimer Le Message</a>';
                  echo '</td>';
                  echo '</tr>';
                }
          ?>  
