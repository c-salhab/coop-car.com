<!DOCTYPE html>
<html>
        <?php $title = 'Inscription'; include('include/head.php'); ?>
<style>
        /* @extend display-flex; */
...
<main>
        ...
        <form action="verification_inscription.php" method="POST" class="register-form" id="register-form" enctype="multipart/form-data">
        
        <div class="form-group">
            <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
            <input type="text" name="u" class="in" id="FirstName" placeholder="Identifiant"/>
        </div>
        ...
        <p>le type d'image accepté : JPEG</p>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <label for="agree-term" class="label-agree-term"><span><span></span></span>Je suis d'accord avec toutes les déclarations dans <a href="privacy.php"                 class="term-service">Conditions d'utilisation</a></label>
        </div>
        
        <div class="form-group form-button">
        <input type="submit" name="submit" id="SignUp" class="form-submit" value="S'inscrire"/>
        </div>
        ...
        <figure><img src="images/hi.jpg" alt="sign  up image"></figure>
